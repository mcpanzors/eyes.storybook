...
class EyesWebDriverRunner {
  ...
  testStories(stories) {
    ...
    const defaultConcurrency = DEFAULT_CONCURRENCY > stories.length ? stories.length : DEFAULT_CONCURRENCY;
    const maxConcurrency = maxThreads > stories.length ? stories.length : maxThreads;
...
exports.EyesWebDriverRunner = EyesWebDriverRunner;
